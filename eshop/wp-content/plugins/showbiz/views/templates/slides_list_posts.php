				...
				?>
					<li id="slidelist_item_<?php echo $postID?>" class="ui-state-default">
						...
						<span class="slide-col col-name">
							<?php echo $linkEdit?>
							<a class='button_edit_slide greenbutton' href='<?php echo $urlEditSlide?>' target="_blank">Edit Post</a>
						</span>
						...
						<span class="slide-col col-operations-posts">
							<a id="button_delete_slide_<?php echo $postID?>" class='button-secondary button_delete_slide' href='javascript:void(0)'>Delete</a>
						</span>
