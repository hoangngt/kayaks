 ...
 * German Version with fee
 *
 * @class 		woocommerce_cash_on_delivery_payment
 * @package		WooCommerce_de
 * @category	Payment Gateways
 * @author		Patrick Garman (www.patrickgarman.com)
 */
class WGM_Gateway_Cash_on_delivery extends WC_Payment_Gateway {
    ...
    function init_form_fields() {
    	$this->form_fields = array(
			...
			'woocommerce_cash_on_delivery_fee' => array(
				'title' => __( 'Gebühr', 'woocommerce' ), 
				'type' => 'text',
				'css'  => 'width:50px;',
				'description' =>  ' '. get_option( 'woocommerce_currency' ) . ' ' . __( 'Gebühr für das Zahlen per Nachnahme.', 'woocommerce' ), 
				'default' => ''
			), 
 	   );
    }
...
function woocommerce_cod_de_add_gateway ($methods) { $methods[] = 'woocommerce_cash_on_delivery_payment'; return $methods; }
add_filter ('woocommerce_payment_gateways', 'woocommerce_cod_de_add_gateway');