...
$showTaxes = $showTaxes && get_option( WGM_Helper::get_wgm_option( 'woocommerce_de_kleinunternehmerregelung' ) ) == 'off';
?>
...
<table class="shop_table cart" cellspacing="0">
	...
	<tbody>
						...
						<?php if ($showTaxes): ?>
							<td class="product-tax">
								<?php
									...
									echo woocommerce_price( $values['line_tax'] ) . ' (' . round( $tax[ 'rate' ],1 ) . '%)';
								?>
							</td>
						<?php endif; ?>
					</tr>
		...
		?>
		<tr>
			<td colspan="<?php echo apply_filters( 'wgm_cart_colspan_value', '6' ); ?>" class="actions">
