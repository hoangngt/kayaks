 ...
 * <div class="updated woocommerce-de-message">
    ...
    <h5><span class="error-label">Achtung!</span><b>Es existieren keine rechtskonforme Shop-Seiten!</b></h5>
    <p style="font-size:15px;">
        Die Seiten können die Seiten, automatisch oder manuell wieder anlegen.
    </p>
    <input type="submit" class="button-primary" name="woocommerce_de_install" value="<?php _e(  'automatisch anlegen', Woocommerce_German_Market::get_textdomain() );?>" />          
    <input type="submit" class="button-primary" name="woocommerce_de_install" value="<?php _e(  'manuell anlegen', Woocommerce_German_Market::get_textdomain() );?>" />
</div>
*/ ?>
...
<div class="updated woocommerce-de-message">
	...
	<form action="<?php admin_url( 'admin.php' ); ?>">
		<input type="hidden" name="page" value="woocommerce" />
		<?php wp_nonce_field(); ?>
