...
Class WGM_Settings {
	...
	*/
	private static function settings_de_content() {
		...
		$options_settings_pages = array(
			...
			array(
				'name' => __( 'Versandkosten', Woocommerce_German_Market::get_textdomain() ),
				'desc' => __( 'Geben Sie eine Seite für die Versandkosten an', Woocommerce_German_Market::get_textdomain() ),
				'tip'  => $tip_default_text,
				'id'   => WGM_Helper::get_wgm_option( 'versandkosten' ),
				'css'  => 'min-width:50px;',
				'type' => 'single_select_page'
			),
			...
			array(
				...
				'desc' => __( 'Geben Sie die Widerufsfrist in Tagen an', Woocommerce_German_Market::get_textdomain() ),
				'tip'  => __( 'Geben Sie die Widerufsfrist in Tagen an. Standard sind 14 Tage', Woocommerce_German_Market::get_textdomain() ),
			...
			array(
				'name' => __( 'Versandkosten in Übersicht', Woocommerce_German_Market::get_textdomain() ),
				'desc' => __( 'Zeige die Versandkosten in der Übersicht unter jedem Produkt', Woocommerce_German_Market::get_textdomain() ),
				'tip'  => __( 'Zeige die Versandkosten in der Übersicht unter jedem Produkt', Woocommerce_German_Market::get_textdomain() ),
				'id'   => WGM_Helper::get_wgm_option( 'woocommerce_de_show_shipping_fee_overview' ),
				'css'  => 'min-width:50px;',
				'type' => 'select',
				'default'  => 'off',
				'options' => array(
			...
			array(
				'name' => __( 'Versandkosten in der Detailansicht', Woocommerce_German_Market::get_textdomain() ),
				'desc' => __( 'Zeige die Versandkosten in der Produkt Detailansicht', Woocommerce_German_Market::get_textdomain() ),
				'tip'  => __( 'Zeige die Versandkosten in der Produkt Detailansicht', Woocommerce_German_Market::get_textdomain() ),
				'id'   => WGM_Helper::get_wgm_option( 'woocommerce_de_show_shipping_fee_overview_single' ),
				'css'  => 'min-width:50px;',
				'type' => 'select',
				'default'  => 'on',
				'options' => array(
			...
			array(
				'name' => __( 'Impressum in E-Mails', Woocommerce_German_Market::get_textdomain() ),
				'desc' => __( 'Hänge das Impressum an jede E-Mail', Woocommerce_German_Market::get_textdomain() ),
				'tip'  => __( 'Hänge das Impressum an jede E-Mail', Woocommerce_German_Market::get_textdomain() ),
				'id'   => WGM_Helper::get_wgm_option( 'woocommerce_de_append_imprint_to_mail' ),
				'css'  => 'min-width:50px;',
				'type' => 'select',
				'default'  => 'on',
				'options' => array(
			...
			array(
				'name' => __( 'Widerrufsrecht in E-Mails', Woocommerce_German_Market::get_textdomain() ),
				'desc' => __( 'Hänge das Widerrufsrecht  an jede E-Mail', Woocommerce_German_Market::get_textdomain() ),
				'tip'  => __( 'Hänge das Widerrufsrecht  an jede E-Mail', Woocommerce_German_Market::get_textdomain() ),
				'id'   => WGM_Helper::get_wgm_option( 'woocommerce_de_append_withdraw_to_mail' ),
				'css'  => 'min-width:50px;',
				'type' => 'select',
				'default'  => 'on',
				'options' => array(
			...
			array(
				'name' => __( 'Allgemeine Geschäftsbedingungen in E-Mails', Woocommerce_German_Market::get_textdomain() ),
				'desc' => __( 'Hänge die Allgemeinen Geschäftsbedingungen an jede E-Mail', Woocommerce_German_Market::get_textdomain() ),
				'tip'  => __( 'Hänge die Allgemeinen Geschäftsbedingungen an jede E-Mail', Woocommerce_German_Market::get_textdomain() ),
				'id'   => WGM_Helper::get_wgm_option( 'woocommerce_de_append_terms_to_mail' ),
				'css'  => 'min-width:50px;',
				'type' => 'select',
				'default'  => 'on',
				'options' => array(
	...
	* @return void
	*/
	public function add_process_product_meta( $post_id, $post ) {
	...
	public static function add_product_write_panels() {
		...
		<div id="delivery_time" class="panel woocommerce_options_panel" style="display: block; ">
			<p class="form-field">
				...
				<select name="lieferzeit" id="lieferzeit_product_panel">
					<option value="-1"><?php _e( 'Bitte Auswählen' ); ?></option>
					<?php
					foreach ( $terms as $i  )  {
		...
		<div id="shipping_options" class="panel woocommerce_options_panel" style="display: block; ">
			<p class="form-field">
				...
				&nbsp;<input type="checkbox" name="_suppress_shipping_notice" value="on" <?php checked( $data_shipping, 'on' ); ?>/>
				<br />
				<small><?php _e( 'Den Versandkostenhinweis nur für dieses Produkt im Frontend und Mails nicht anzeigen (z.B.: bei Downloads )', Woocommerce_German_Market::get_textdomain() );?></small>
			</p>
		</div>
	...
	*/
	public static function select_scale_units( $field ) {
		...
		$attribute_taxonomy_name = $woocommerce->attribute_taxonomy_name( $default_product_attributes[ 0 ][ 'attribute_name' ] );
